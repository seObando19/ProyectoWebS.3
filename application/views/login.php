...
<?php echo form_open('login/acceso/') ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="correo@gmail.com" title="Ingrese su correo" required="" value="" name="correo" id="correo" class="form-control">
                                <span class="help-block small">El correo es su login de acceso</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="clave">clave</label>
                                <input type="password" title="Ingrese su clave" placeholder="******" required="" value="" name="clave" id="clave" class="form-control" autocomplete="off">
                                <span class="help-block small"></span>
                            </div>                     									
                                <button class="btn btn-success btn-block loginbtn">Login</button>
                                <p>Copyright © <?php echo date("Y") ?> <a href="https://colorlib.com/wp/templates/">web II</a>Todos los derechos de autor</p>           
