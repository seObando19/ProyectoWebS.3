<?php 
/*Script donde se aloja los graficos de ventas de los productos de la principal*/
 ?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap">
                            <div class="widget-head-info-box">
                                ...
                                <img src="<?php echo base_url(); ?>/assets/img/notification/5.jpg" class="img-circle circle-border m-b-md" alt="profile">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            <div class="author-wiget-inner">
                                <div class="perso-img">
                                    <img src="<?php echo base_url(); ?>/assets/img/notification/6.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap personal-info-ano res-mg-t-30">
                            <div class="widget-head-info-box">
                                ...
                                <img src="<?php echo base_url(); ?>/assets/img/contact/2.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                <div class="social-widget-result">
                                    <span>100 Tweets</span> |
                                    <span>350 Following</span> |
                                    <span>610 Followers</span>
